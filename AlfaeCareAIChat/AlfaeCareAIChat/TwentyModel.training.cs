...
{
    public partial class TwentyModel
    {
        public const string RetrainFilePath =  @"C:\Users\Hakan.Adenback\Downloads\autoGenQuestion.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.1729615F,L2Regularization=0.03125F,LabelColumnName=@"col2",FeatureColumnName=@"Features"}))      
