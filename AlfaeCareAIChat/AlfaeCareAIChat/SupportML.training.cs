...
{
    public partial class SupportML
    {
        public const string RetrainFilePath =  @"C:\Users\Hakan.Adenback\Downloads\Questions.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(new SdcaMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.2082452F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
