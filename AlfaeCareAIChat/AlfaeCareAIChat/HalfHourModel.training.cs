...
namespace AlfaeCareAIChat
{
    public partial class HalfHourModel
    {
        public const string RetrainFilePath =  @"C:\Users\Hakan.Adenback\source\repos\CorvuxScandi\AlfaeCareChatAI\AlfaeCareAIChat\AlfaeCareAIChat\Questions.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=30,NumberOfTrees=5,MaximumBinCountPerFeature=123,FeatureFraction=0.975628884335464,LearningRate=0.877830252306393,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
