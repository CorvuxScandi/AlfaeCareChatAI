...
namespace AlfaeCareAIChat
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Hakan.Adenback\Downloads\sentiment labelled sentences\sentiment labelled sentences\imdb_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.05225741F,L2Regularization=0.186558F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
